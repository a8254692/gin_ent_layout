...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			merchantchannelbind.Table: merchantchannelbind.ValidColumn,
			merchantlist.Table:        merchantlist.ValidColumn,
			sysmenu.Table:             sysmenu.ValidColumn,
			syspermissions.Table:      syspermissions.ValidColumn,
			sysrolemenu.Table:         sysrolemenu.ValidColumn,
			sysrolepermissions.Table:  sysrolepermissions.ValidColumn,
			sysroleusers.Table:        sysroleusers.ValidColumn,
			sysroles.Table:            sysroles.ValidColumn,
